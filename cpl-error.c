...
CPL_ERROR cpl_errors[NUM_ERRORS] = {
        ...
        {7,    "Internal CPL error: the value of the loop control variable %s for this iterative \"&D0\" loop could not be retrieved. Please contact your system administrator ."},
